...
{
    public partial class initnet50 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    TimeInQueue = table.Column<TimeSpan>(type: "TEXT", nullable: false),
                    ServersJoined = table.Column<int>(type: "INTEGER", nullable: false),
                    ServersJoinMissed = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
